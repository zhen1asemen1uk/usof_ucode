...
class authModel extends Model {
   ...
   //       //check unique users
   //       let check = await userController.getUser(login, email);
   ...
   //          await userController.addUser(login, hashPass, email, avatar, activationLink);
   //          let check = await userController.getUser(login, email);
   //          let [rows, fields] = check;
   //          let user = rows[0];
   //          //generation token
   ...
   //       let check = await userController.loginUser(login);
   //       let [rows, fields] = check;
   //       let user = rows[0];
   ...
   //       let resolt = await userController.loginUser(login);
   ...
   //       await userController.resetPass_userId(id, hashPass);
   ...
   //             const activationLink = uuid.v4();
   //             //add user data
   //             await userController.addUser_ADMIN(login, hashPass, email, avatar, status, verify, activationLink);
   //             let check = await userController.getUser(login, email);
   //             let [rows, fields] = check;
   //             let user = rows[0];
   //             //generation token
