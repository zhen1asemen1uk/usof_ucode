...
import {
	getAllCategories_Type,
	getDataCategoryByID_Type,
	getPostsByCategotyID_Type,
	addCategory_Type,
	updateCategory_Type,
	deleteCategory_Type,
} from './types';
...
export const categoryReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case getDataCategoryByID_Type:
			const getDataCategoryByID = categoryAPI.getDataCategoryByID(
				action.payload.id
			);
		...
		case getPostsByCategotyID_Type:
			const getPostsByCategotyID = categoryAPI.getPostsByCategotyID(
...
export const getAllCategories_Category = (payload) => ({
	type: getAllCategories_Type,
	payload,
});
export const getDataCategoryByID_Category = (payload) => ({
	type: getDataCategoryByID_Type,
	payload,
});
export const getPostsByCategotyID_Category = (payload) => ({
	type: getPostsByCategotyID_Type,
	payload,
});
export const addCategory_Category = (payload) => ({
	type: addCategory_Type,
	payload,
});
export const updateCategory_Category = (payload) => ({
	type: updateCategory_Type,
	payload,
});
export const deleteCategory_Category = (payload) => ({
	type: deleteCategory_Type,
	payload,
});
