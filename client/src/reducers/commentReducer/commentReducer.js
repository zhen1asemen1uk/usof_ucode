...
export const commentReducer =  (state = initialState, action) => {
   switch (action.type) {
      ...
      case getCommentLikesByID_Type:
         const getCommentLikesByID =  commentAPI.getCommentLikesByID(action.payload.id)

         console.log(getCommentLikesByID);
         return { ...state, commentData: getCommentLikesByID }

      case addLikesByCommentID_Type:
         const addLikesByCommentID =  commentAPI.addLikesByCommentID(action.payload.id)
      ...
      case deleteLikeByCommentID_Type:
         const deleteLikeByCommentID =  commentAPI.deleteLikeByCommentID(action.payload.id)
