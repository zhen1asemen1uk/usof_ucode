...
export const getAllUsers_User = (payload) => ({
	type: getAllUsers_Type,
	payload,
});
export const getUserByID_User = (payload) => ({
	type: getUserByID_Type,
	payload,
});
export const registerForADMIN_User = (payload) => ({
	type: registerForADMIN_Type,
	payload,
});
export const addAvatar_User = (payload) => ({ type: addAvatar_Type, payload });
export const updateUser_User = (payload) => ({
	type: updateUser_Type,
	payload,
});
export const deleteUser_User = (payload) => ({
	type: deleteUser_Type,
	payload,
});
