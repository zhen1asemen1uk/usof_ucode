...
export const sortByTitleASC_Type = 'sortByTitleASC';
export const sortByTitleDESC_Type = 'sortByTitleDESC';
export const sortByAuthorASC_Type = 'sortByAuthorASC';
export const sortByAuthorDESC_Type = 'sortByAuthorDESC';
